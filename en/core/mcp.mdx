...
<CardGroup cols={2}>
  ...
  <Card title="Secure by design" icon="shield">
    OAuth 2.1 with PKCE — you control which organization and permissions to
    grant.
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="No sessions returned">
    The MCP Server only returns sessions from the organization you authorized.
    If you have multiple organizations, make sure you selected the right one
